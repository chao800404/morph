...
import { AssetProperties } from "@/routes/_backend/dashboard/-components/assets-card/asset-properties";
import { useAssetsStore } from "@/routes/_backend/dashboard/-views/global/contents/assets/stores/assets.store";

import { cn } from "@/lib/utils";
import { AssetFeatureMotionButton } from "@/routes/_backend/dashboard/-components/assets-card/asset-feature-motion-button";
import { AssetPropertyHeader } from "@/routes/_backend/dashboard/-components/assets-card/asset-property-header";
...
export function AssetDetailDialog() {
  ...
  useEffect(() => {
    ...
    const isActive =
      !!activeItem && activeItem.type === "asset" && !isLargeScreen;
