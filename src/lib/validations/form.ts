...
// Field value schema
const fieldValueSchema = z.string().transform(val => sanitizeStringInternal(val));
...
// Language select FormField schema
const languageFormFieldSchema = z.object({
    name: fieldNameSchema,
...
export const formFieldSchema: z.ZodType<
    ...
    | { name: string; type: "select"; value: string; options: Array<{ label: string; value: string }> }
    | { name: string; type: "folder-select"; value: string; placeholder?: string; excludedIds?: string[] }
    | { name: string; type: "language"; value: string }
    | { name: string; type: "hidden"; value: string }
> = z.discriminatedUnion("type", [
    baseFormFieldSchema,
    selectFormFieldSchema,
    folderSelectFormFieldSchema,
    languageFormFieldSchema,
