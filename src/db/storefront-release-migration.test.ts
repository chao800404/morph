...
describe("storefront release migration regression", () => {
  it("preserves a 0045 release while applying 0046 and 0047", () => {
    ...
    db.exec(`
      ...
      INSERT INTO storefront_theme_revisions (id) VALUES ('source-a');
      INSERT INTO storefront_theme_builds (id) VALUES ('build-a');
