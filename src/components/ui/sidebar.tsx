...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        "relative border-b border-dashed flex w-full min-w-0 flex-col p-2",
        className,
      )}
      {...props}
    />
...
function SidebarMenu({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      data-sidebar="menu"
      className={cn(
        "flex w-full min-w-0 flex-col gap-1 text-muted-foreground",
        className,
      )}
      {...props}
    />
...
function SidebarSingleMenuItem({
  className,
  ...props
}: React.ComponentProps<"div">) {
  return (
...
function SidebarArrow({ color = "#949494" }: { color?: string }) {
  return (
    ...
    >
      ...
      <path
        d="M12 0V16.5C12 19.2614 14.2386 21.5 17 21.5H23.5"
        stroke={color}
        strokeWidth="2"
      />
    </svg>
