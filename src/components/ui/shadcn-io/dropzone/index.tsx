    ...
    return (
        <DropzoneContext.Provider key={JSON.stringify(src)} value={{ src, accept, maxSize, minSize, maxFiles }}>
            <Button
                ...
                className={cn(
                    "bg-zinc-100 shadow-sm p-5 rounded-md-plus shadow-zinc-300 text-foreground placeholder:text-zinc-400 border border-border inset-shadow-xs inset-shadow-white",
                    ...
                    "data-[error=true]:ring-destructive data-[error=true]:ring-1",
...
export const DropzoneEmptyState = ({ children, className }: DropzoneEmptyStateProps) => {
    ...
    return (
        <div className={cn("flex flex-col items-center justify-center", className)}>
            ...
            <p className="my-2 w-full truncate font-medium text-sm">Upload {maxFiles === 1 ? "a file" : "files"}</p>
